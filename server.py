...
def publicfile(request, handler):
    mineType = {".html": "text/html",".css": "text/css",".js": "application/javascript",".jpg": "image/jpg",".ico": "image/x-icon",".gif": "image/gif",".jpeg": "image/jpeg",".webp": "image/webp",".png": "image/png"}
